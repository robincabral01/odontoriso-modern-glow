        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              Localizada no coração de Imperatriz - MA, a Clínica Odontoriso é referência 
              em tratamentos odontológicos de excelência. Com mais de 10 anos de experiência, 
              nossa equipe de profissionais altamente qualificados oferece os mais modernos 
          ...
          <div className="service-card p-8">
            <img 
              ...
              alt="Interior moderno da Clínica Odontoriso"
