...
const ImplantesDentarios = () => {
  const benefits = ["Recuperação completa da função mastigatória", "Solução definitiva e duradoura", "Preservação dos dentes adjacentes"];
  return <div className="min-h-screen">
      <Header />
      <Hero title="Implantes Dentários" subtitle="Recupere a função e estética dos seus dentes com segurança e tecnologia avançada" />
        ...
        <div className="container-main relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20">
              <div className="mb-6">
                <img 
                  src="/lovable-uploads/895a7686-89b5-4839-9689-37610da3985d.png" 
